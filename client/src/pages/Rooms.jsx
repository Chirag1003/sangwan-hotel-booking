...
//     image: 'https://source.unsplash.com/600x400/?hotel,double-room'
//   },
//   {
//     type: 'Triple',
//     price: 200,
//     description: 'Great for families or groups. Comfort and space combined.',
//     image: 'https://source.unsplash.com/600x400/?hotel,triple-room'
//   }
// ];

// export default function Rooms() {
//   return (
//     <div className="max-w-6xl mx-auto px-6 pb-10 pt-24">
//       <h2
//   className="text-3xl font-bold mb-6 text-center"
//   style={{ color: 'rgb(240, 240, 242)' }}
// >
//   Choose Your Room
// </h2>
//       <p className="text-center text-2xl mb-10" style={{ color: 'rgb(240, 240, 242)' }}>All rooms come with complimentary breakfast and Wi-Fi.</p>
...
//               <h3 className="text-xl font-semibold text-blue-800">{room.type} Room</h3>
