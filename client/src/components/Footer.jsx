...
//           <a href="#" className="font-semibold hover:text-yellow-500 transition-colors duration-200">About Us</a>
// <a href="#" className="hover:text-yellow-500 transition-colors duration-200">Contact</a>
// <a href="#" className="hover:text-yellow-500 transition-colors duration-200">Terms & Conditions</a>
